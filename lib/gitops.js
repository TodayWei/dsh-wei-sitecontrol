...
async function loadGit() {
  if (cached === null) {
    // The HTTP side is ours, not isomorphic-git/http/node: see lib/githttp.js
    // for why (Node 19+ default agent kills slow pushes with a bogus
    // "Request timed out", and the built-in client ignores system proxies).
